...
public class PerformanceControllersAspect {
     ...
     */
    @Pointcut (
                "execution(public * it.almaviva.difesa.sipad.ageLimits..*.*(..)) || " +
                        "execution(public * it.almaviva.difesa.sipad.employee..*.*(..)) || " +
                        "execution(public * it.almaviva.difesa.sipad.hierarchy..*.*(..)) || " +
                        "execution(public * it.almaviva.difesa.sipad.proceeding..*.*(..)) || " +
                        "execution(public * it.almaviva.difesa.sipad.shared..*.*(..))" )
