package it.almaviva.difesa.sipad.aadba.vwsg123stgiuridicodsunific.criteria;
...
@Getter
@Setter
public class VwSg123StgiuridicoDsCriteria implements GenericCriteriaModel {
    ...
    private Set<RoleCatpersForzaarmataDTO> roleCatpersForzaarmata;
